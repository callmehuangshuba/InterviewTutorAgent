...
def load_system_prompts():
    ...
    try:
        ...
        raise e
def load_system_prompts2():
    try:
        system_prompt_path = get_abs_path(prompts_conf["main2_prompt_path"])
    except KeyError as e:
        logger.error(f"[load_system_prompts]在yaml配置项中没有main2_prompt_path配置项")
        raise e
